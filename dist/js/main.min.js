...
var elGenie=function(){function t(){playing&&$(".images img:eq(1)").fadeIn(700,function(){$(this).fadeOut(700,t)})}function i(t){function i(){R.position.x=.465*g|0,R.position.y=205+370*R.anchor.y}function e(){E=w.resizePolygon(A,null,h),O=w.rectOfPolygon(E);var t=R.x-774*h*R.anchor.x,i=R.y-364*h*R.anchor.y;w.movePolygon(E,t,i),S=new PIXI.Polygon(E)}function c(){function t(){if(R){if(R.alpha<.1)return;R.alpha*=.98,setTimeout(u,t)}}f=!1;var i=3e3,e=$("#video_id");e.fadeIn(i,function(){$(n).remove(),videojs("video_id").ready(function(){this.play()})}),t()}function l(){function t(){i(t)}function i(t){o+=n;var i=R.y+o;i>e&&(i=e-(i-e),R.wobbleFactor=.2*(o/80),d(),d(),setTimeout(function(){d(),m()},0),o=-o/2,a++),R.y=i,r>a?setTimeout(t,u):(R.y=e,_=!1)}var e=R.y;R.y=-R.height;var n=2,o=5,a=0,r=5;X.addChild(R),t()}function d(t,i){if(!t||!i)for(var e=0;100>e;e++)if(t=R.x-R.width+Math.random()*R.width*2,i=R.y-R.height+Math.random()*R.height*2,S.contains(t,i)){e=100;break}var n=new p(t,i);Q.push(n),B.addChild(n)}function m(t,i){t&&i||(t=R.position.x,i=R.position.y);var e=w.distance(R,{x:t,y:i});switch(r){case 0:e=(.9*Math.random()+.1)*e;break;case 1:e=(.3*Math.random()+.7)*e}var n=t-R.x,o=i-R.y,h=Math.atan(o/n),s=R.rotation+h,c=R.x-e*Math.cos(s)*(n>0?-1:1),l=R.y-e*Math.sin(s)*(o>0?1:1);switch(y&&y.setInfo2("x: "+t+", y: "+i+"\nd: "+e+", cos: "+Math.cos(s)*e+", sin: "+Math.sin(s)*e),r){case 2:for(var u=0;100>u;u++)if(c=R.x-R.width+Math.random()*R.width*2,l=R.y-R.height+Math.random()*R.height*2,S.contains(c,l)){u=100;break}}var d=new p(c,l);d.scale.x=d.scale.y=2+(a?1:0)+Math.random(),d.anchor.x=d.anchor.y=.5,d.move=function(){switch(this.v.y+=this.g,r){case 0:this.x+=this.v.x*Math.sin(this.y)*2|0;case 1:this.x+=this.v.x*Math.sin(this.y)*1|0;default:this.x+=this.v.x}this.y+=this.v.y},d.v.y-=.5*Math.abs(s),Q.push(d),B.addChild(d)}function p(t,i){var e=new PIXI.Sprite(q[0]);return e.interactive=e.buttonMode=!1,e.position.x=t,e.position.y=i,e.ticks=0,e.limit=0+4*Math.random()-1|0,e.subImg=0,e.removed=!1,e.g=.02*Math.random(),e.v={x:w.randomFlip(.8),y:0},e.tick=function(){this.ticks++,this.ticks>this.limit&&(this.ticks=0,this.texture=q[this.subImg++%q.length]),this.rotation+=.001,this.subImg>=q.length&&this.kill(),this.move()},e.move=function(){this.v.y+=this.g,this.x+=this.v.x,this.y+=this.v.y},e.kill=function(){this.removed=!0},e}function I(){M(I)}function P(){V++,F(P)}function F(t){R.tick();for(var i=[],e=0;e<Q.length;e++){var n=Q[e];n.removed?B.removeChild(n):(n.tick(),i.push(n))}Q=i,setTimeout(t,v)}function M(t){o&&y&&y.setInfo1("w: "+T.view.width+", h: "+T.view.height+"\n | iw: "+window.innerWidth+", ih: "+window.innerHeight+"\n | "+(L?"ON (space)":"OFF (space)")),T.render(X),setTimeout(t,u)}function k(){var t=s,n=window.innerHeight;if(T.view.style.position="absolute",T.view.style.top="0px",T.view.style.left="0px",T.resize(t,n),_||i(),e(),C(),R.hitArea&&o){var a=new PIXI.Graphics;a.beginFill(65280),a.drawRect(R.hitArea.x+R.width*R.anchor.x,R.hitArea.y+R.height*R.anchor.y,R.hitArea.width,R.hitArea.height),a.endFill(),X.addChild(a)}}function C(){a&&(R.hitArea=new PIXI.Rectangle(-R.width*R.anchor.x,-R.height*R.anchor.y,window.innerWidth,window.innerHeight))}if(t||document.getElementById(b)?n=document.getElementById(t):(n=document.createElement("canvas"),n.id=b,document.body.appendChild(n)),!n||"object"!=typeof n)return void console.log("elGenie app wasn't able to initialize a canvas. Try giving it a canvas Id.");var X=new PIXI.Stage(3822),T=PIXI.autoDetectRenderer(g,x,n,!0);T.view.style.position="absolute",T.view.style.top="0px",T.view.style.left="0px";var W=PIXI.Texture.fromImage("images/genie_lamp.png"),R=new PIXI.Sprite(W);R.anchor.x=.5,R.anchor.y=.5,i(),R.scale.x=R.scale.y=h;var E,O,S,A=[0,100,420,0,740,50,750,250,510,350,300,350,0,160];if(e(),o){var G=new PIXI.Graphics;G.beginFill(65280,.5),w.drawPolygon(G,E),X.addChild(G)}C(),R.interactive=!0,R.buttonMode=!0,R.defaultWobbleFactor=.007*(a?4:2),R.baseWobbleFactor=.005,R.wobbleFactor=.005,R.rub=function(){this.rubStart=V,this.rubCycle=V,this.isRubbing=!0,this.wobbleFactor+=R.defaultWobbleFactor},R.tick=function(){if(this.rotation=Math.sin(V/2)*this.wobbleFactor,f)if(this.isRubbing){if(V>this.rubStart+1*v)return void(this.isRubbing=!1);var t=R;this.wobbleFactor>.015&&10*Math.random()<1&&m(t.x-.35*t.width,t.y-.11*t.height),this.wobbleFactor>.1&&10*Math.random()<2&&m(t.x+.35*t.width,t.y+.07*t.height),this.wobbleFactor>.15&&10*Math.random()<3&&(m(t.x+.05*t.width,t.y-.3*t.height),m(t.x+.1*t.width,t.y+.15*t.height)),this.wobbleFactor>.3&&c()}else this.wobbleFactor<this.baseWobbleFactor?this.wobbleFactor=this.baseWobbleFactor:this.wobbleFactor*=.95};var z=R;z.mouseup=z.mouseupoutside=z.touchend=z.touchendoutside=function(){this.startPosition=null},R.mousedown=R.click=R.touchdown=function(t){t.originalEvent.preventDefault(),R.rub()};var D=a?6:12,H=0;o&&(R.click=function(t){t.originalEvent.preventDefault(),r++,r%=3});var L=!0;o&&(window.onkeyup=function(t){var i=t.keyCode?t.keyCode:t.which;32==i&&(L=!L)}),R.mousedown=R.touchstart=function(t){t.originalEvent.preventDefault()},R.mousemove=R.touchmove=function(t){t.originalEvent.preventDefault();var i=t.getLocalPosition(R.parent);if(H++,H>D&&(H=0,L))for(var e=0;(a?1:2)>e;e++){var n=new p(i.x+5*e-16,i.y-16);n.v.x+=.15*e,n.v.y+=.2,n.scale.x=n.scale.y=a?2:1,Q.push(n),B.addChild(n)}if(R.startPosition){var o=w.distance(i,R.startPosition);o>R.width/4&&(R.rub(),R.startPosition=null)}else w.pointIntersects(i,R)&&(R.startPosition=i)};var _=!0;l();var B=new PIXI.SpriteBatch;X.addChild(B);for(var j=PIXI.Texture.fromImage("images/sparkle.png"),q=[],U=32,N=32,J=0;8>J;J++)for(var K=0;4>K;K++)q.push(new PIXI.Texture(j,new PIXI.Rectangle(J*U,K*N,U,N)));var Q=[];I();var V=0;P(),C(),window.addEventListener("resize",k,!1)}var e=!0;!function(){function t(){e&&i.fadeIn(n,function(){i.fadeOut(n,t)})}var i=$("#elStarsImageGlow"),n=1e3;i&&t()}();var n,o=($("#elStarsImage"),!1),a=WURFL?WURFL.is_mobile:!0,r=2,h=1,s=960,c=window.innerHeight,l=a?20:20,u=1e3/l,d=a?20:20,v=1e3/d,f=!0,y=null,w={distance:function(t,i){var e=i.x-t.x,n=i.y-t.y;return Math.sqrt(e*e+n*n)},pointIntersects:function(t,i){var e=i.x-i.width*i.anchor.x||0,n=i.y-i.height*i.anchor.y||0,o=i.width,a=i.height;return!(t.x>e+o||t.x<e||t.y>n+a||t.y<n)},rectOfPolygon:function(t){for(var i=0;i<t.length;i+=2){var e={x1:0,y1:0,x2:0,y2:0},n=t[i],o=t[i+1];n<e.x1&&(e.x1=n),n>e.x2&&(e.x2=n),o<e.y1&&(e.y1=o),o>e.y2&&(e.y2=o)}return{x:e.x1,y:e.y1,w:e.x2-e.x1,h:e.y2-e.y1}},drawPolygon:function(t,i){if(!(i.length<2)){var e=t,n=0;for(e.moveTo(i[n++],i[n++]);n<i.length-1;)e.lineTo(i[n++],i[n++]);e.endFill()}},resizePolygon:function(t,i,e){for(var i=i||{x:0,y:0},n=w.rectOfPolygon(t),o=[],a=0;a<t.length;a+=2){var r=t[a],h=t[a+1];o.push(r*e||1),o.push(h*e||1)}for(var s=w.rectOfPolygon(o),c={x:n.w*i.x,y:n.h*i.y},l={x:s.w*i.x,y:s.h*i.y},u={x:c.x-l.x,y:c.y-l.y},a=0;a<o.length;a+=2)o[a]+=u.x,o[a+1]+=u.y;return o},movePolygon:function(t,i,e){if(!(t.length<2))for(var n=0;n<t.length;n+=2)t[n]+=i,t[n+1]+=e},randomFlip:function(t){return t=Math.abs(t),2*Math.random()*t-t}},g=s||window.innerWidth,x=c||window.innerHeight,b="elGenieCanvas";return{init:function(t){i(t)}}}();