...
var Info = function () {
	...
	container.style.cssText = 'width:260px;opacity:0.9;cursor:pointer';
	...
	fpsText.id = 'fpsText';
	fpsText.style.cssText = 'color:#0ff;font-family:Helvetica,Arial,sans-serif;font-size:30px;font-weight:bold;line-height:43px';
